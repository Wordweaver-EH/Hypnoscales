...
score thresholds at the 33rd/67th percentile boundaries. For discrete motor
composites, the realised high group is typically smaller than one third of the
sample (22--28\% in most datasets); actual proportions are reported alongside
each $\kappa$ estimate. Weighted Cohen's $\kappa$ (linear weights) was used. Both the full-scale total and the overlap-free
